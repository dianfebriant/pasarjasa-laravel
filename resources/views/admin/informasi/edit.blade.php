                    ...
                    <form action="{{ route('information.update', $information) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('name') is-invalid @enderror" name="name"
                                value="{{ old('name', $information->name) }}" placeholder="Masukkan Judul Informasi">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control @error('body') is-invalid @enderror" name="body" id="my-editor"
                                rows="5">{{ old('body', $information->body) }}</textarea>
                        ...
                        <div class="form-group">
                            ...
                            <input type="file" class="form-control @error('image') is-invalid @enderror" name="image" value="{{ old('image', $information->image) }}">
